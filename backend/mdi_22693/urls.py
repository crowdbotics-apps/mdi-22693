...
admin.site.site_header = "MDI"
admin.site.site_title = "MDI Admin Portal"
admin.site.index_title = "MDI Admin"

# swagger
api_info = openapi.Info(
    title="MDI API",
    default_version="v1",
    description="API documentation for MDI App",
)
